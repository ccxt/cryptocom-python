...
- `custom_handle_margin_mode_and_params(self, methodName: Any, params={})`
- `describe(self)`
- `edit_order_request(self, id: str, symbol: Str, amount: Num, price: Num = None, params={})`
- `edit_order(self, id: str, symbol: str, type: OrderType, side: OrderSide, amount: Num = None, price: Num = None, params={})`
- `nonce(self)`
- `params_to_string(self, object: Any, level: Any)`
...
- `watch_public(self, messageHash: Any, params={})`
- `watch_public_multiple(self, messageHashes: Any, topics: Any, params={})`
...
- `watch_private_request(self, nonce: Any, params={})`
- `watch_private_subscribe(self, messageHash: Any, params={})`
