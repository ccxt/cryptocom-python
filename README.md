...
- `create_advanced_order_request(self, symbol: Str, type: Str, side: Str, amount: Num, price: Num = None, params: dict = {})`
...
- `custom_handle_margin_mode_and_params(self, methodName: object, params: dict = {})`
- `describe(self)`
- `edit_order_request(self, id: str, symbol: Str, amount: Num, price: Num = None, params: dict = {})`
- `edit_order(self, id: str, symbol: str, type: OrderType, side: OrderSide, amount: Num = None, price: Num = None, params: dict = {})`
- `nonce(self)`
- `params_to_string(self, object: object, level: float)`
...
- `v1_private_post_private_get_fee_credit_balances(request)`
...
- `v1_private_post_private_bot_create_trading_bot(request)`
- `v1_private_post_private_bot_update_trading_bot(request)`
- `v1_private_post_private_bot_terminate_trading_bot(request)`
- `v1_private_post_private_bot_pause_trading_bot(request)`
- `v1_private_post_private_bot_resume_trading_bot(request)`
- `v1_private_post_private_bot_get_trading_bots(request)`
- `v1_private_post_private_bot_get_trading_bot_executions(request)`
...
- `un_watch_order_book_for_symbols(self, symbols: list[str], params: dict = {})`
- `watch_trades(self, symbol: str, since: Int = None, limit: Int = None, params: dict = {})`
- `un_watch_trades(self, symbol: str, params: dict = {})`
...
- `watch_public(self, messageHash: Str, params: dict = {})`
- `watch_public_multiple(self, messageHashes: list[str], topics: list[str], params: dict = {})`
- `un_watch_public_multiple(self, topic: str, symbols: list[str], messageHashes: list[str], subMessageHashes: list[str], topics: list[str], params: dict = {}, subExtend: dict = {})`
- `watch_private_request(self, nonce: float, params: dict = {})`
- `watch_private_subscribe(self, messageHash: Str, params: dict = {})`
