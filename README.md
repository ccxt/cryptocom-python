...
- `create_advanced_order_request(self, symbol: Str, type: Str, side: Str, amount: Num, price: Num = None, params={})`
...
- `custom_handle_margin_mode_and_params(self, methodName: object, params={})`
- `describe(self)`
- `edit_order_request(self, id: str, symbol: Str, amount: Num, price: Num = None, params={})`
- `edit_order(self, id: str, symbol: str, type: OrderType, side: OrderSide, amount: Num = None, price: Num = None, params={})`
- `nonce(self)`
- `params_to_string(self, object: object, level: object)`
...
- `watch_public(self, messageHash: object, params={})`
- `watch_public_multiple(self, messageHashes: object, topics: object, params={})`
...
- `watch_private_request(self, nonce: object, params={})`
- `watch_private_subscribe(self, messageHash: object, params={})`
